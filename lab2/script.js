...
mapboxgl.accessToken =
  "pk.eyJ1IjoiY3JveTEyMyIsImEiOiJjbHI2ZnhjZGcyOWpsMnNwbm9rMDA0c3R0In0.Ms5jXP0kJtJvPfg85BqviA";

// Define a map object by initialising a Map from Mapbox
const map = new mapboxgl.Map({
  container: "map",
  // Replace YOUR_STYLE_URL with your style URL.
  style: "mapbox://styles/croy123/clrge2jhz00ie01pigav41sft",
  center: [-4.2542, 55.8628],
  zoom: 9
});
